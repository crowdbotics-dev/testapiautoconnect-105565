...
## Project Structure
    ...
    ├── testapiautoconnect_105565  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_105565`
...
2. Clone this repo and `cd testapiautoconnect_105565`
